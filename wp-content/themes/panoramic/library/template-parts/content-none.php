...
<section class="no-results not-found">
	<header class="page-header">
		<h1 class="page-title centered top-padded"><?php echo wp_kses_post( get_theme_mod( 'panoramic-website-text-no-search-results-heading', __( 'Nothing Found!', 'panoramic' ) ) ); ?></h1>
	</header><!-- .page-header -->
