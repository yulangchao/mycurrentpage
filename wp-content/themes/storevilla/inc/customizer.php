 ...
 * Custom Themes Info
*/
  $wp_customize->add_section( 'storevilla_features', array(
      'title'           =>  __('Important Links', 'storevilla'),
      'priority'        =>  1,
  ));

  $wp_customize->add_setting('storevilla_theme_info_theme',array(
      'default' => '',
      'sanitize_callback' => 'storevilla_text_sanitize',
  ));

  $wp_customize->add_control( new StoreVilla_Theme_Info_Custom_Control( $wp_customize ,'storevilla_theme_info_theme',array(
      'label' => __( 'Storevilla Pro Features' , 'storevilla' ),
      'section' => 'storevilla_features',
  )));
