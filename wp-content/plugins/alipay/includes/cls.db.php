...
class ws_alipay_db
{
    ...
    function update_pack_v2()
    {
        ...
        $wpdb->query(
            "ALTER TABLE `$wpdb->wsaliorders` CHANGE `otime` `otime` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00';"
        );
        $wpdb->query(
            "ALTER TABLE `$wpdb->wsaliorders` CHANGE `stime` `stime` DATETIME NOT NULL DEFAULT '0000-00-00 00:00:00';"
        );
        ...
        $wpdb->query(
            "ALTER TABLE `$wpdb->wsaliorders` CHANGE `emailsend` `emailsend` BOOLEAN NOT NULL DEFAULT FALSE DEFAULT false;"
        );
        ...
        $wpdb->query(
            "ALTER TABLE `$wpdb->wsaliproducts` CHANGE `discountb` `discountb` BOOLEAN NOT NULL DEFAULT FALSE;"
        );
        $wpdb->query(
            "ALTER TABLE `$wpdb->wsaliproducts` CHANGE `discount` `discount` FLOAT(3,2) NOT NULL DEFAULT '0.85';"
        );
        ...
        $wpdb->query(
            "ALTER TABLE `$wpdb->wsaliproducts` CHANGE `download` `download` VARCHAR(255) NOT NULL DEFAULT '';"
        );
        $wpdb->query(
            "ALTER TABLE `$wpdb->wsaliproducts` CHANGE `callback` `callback` VARCHAR(100) NOT NULL DEFAULT '';"
        );
        ...
        $wpdb->query(
            "ALTER TABLE `$wpdb->wsaliproducts` CHANGE `location` `location` VARCHAR(20) NOT NULL DEFAULT '';"
        );
        $wpdb->query(
            "ALTER TABLE `$wpdb->wsaliproducts` CHANGE `atime` `atime` TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP;"
        );
        $wpdb->query(
            "ALTER TABLE `$wpdb->wsaliproducts` CHANGE `btime` `btime` DATETIME NOT NULL DEFAULT '2011-10-11 11:11:11';"
        );
        $wpdb->query(
            "ALTER TABLE `$wpdb->wsaliproducts` CHANGE `etime` `etime` DATETIME NOT NULL DEFAULT '2111-11-11 11:11:11';"
        );
        $wpdb->query("ALTER TABLE `$wpdb->wsaliproducts` CHANGE `promote` `promote` BOOLEAN NOT NULL DEFAULT FALSE;");
        $wpdb->query(
            "ALTER TABLE `$wpdb->wsaliproducts` CHANGE `probdate` `probdate` DATE NOT NULL DEFAULT '2011-11-11';"
        );
        $wpdb->query(
            "ALTER TABLE `$wpdb->wsaliproducts` CHANGE `proedate` `proedate` DATE NOT NULL DEFAULT '2111-11-11';"
        );
        $wpdb->query("ALTER TABLE `$wpdb->wsaliproducts` CHANGE `protime` `protime` BOOLEAN NOT NULL DEFAULT FALSE;");
        $wpdb->query(
            "ALTER TABLE `$wpdb->wsaliproducts` CHANGE `probtime` `probtime` TIME NOT NULL DEFAULT '00:00:00';"
        );
        $wpdb->query(
            "ALTER TABLE `$wpdb->wsaliproducts` CHANGE `proetime` `proetime` TIME NOT NULL DEFAULT '23:59:59';"
        );
        ...
        $wpdb->query(
            "ALTER TABLE `$wpdb->wsaliproducts` CHANGE `weight` `weight` DOUBLE(6,2) UNSIGNED NOT NULL DEFAULT '0.99';"
        );
        ...
        //-----------------------------------------------------------------------
        $wpdb->query(
            "ALTER TABLE `$wpdb->wsalitemplates` CHANGE `tplname` `tplname` VARCHAR(20) NOT NULL DEFAULT '未命名模版';"
        );
        $wpdb->query(
            "ALTER TABLE `$wpdb->wsalitemplates` CHANGE `tpldescription` `tpldescription` VARCHAR(255) NOT NULL DEFAULT '模版简要描述';"
        );
